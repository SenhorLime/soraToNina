export const quizData = [
  {
    question:
      "Sora é um(a) estudante do ensino médio normal. Ele começa mais um dia escolar. Se levanta e vai tomar um banho gelado para se despertar. Qual hormônio liberado?",
    answer: {
      a: "Prolactina",
      b: "Cortisol",
      c: "Testoterona",
  ...
  },
 {
  ...
  {
    question:
      "Sora acorda assustado com o sinal do intervalo. Esse susto foi causado por qual hormônio?",
    answer: {
      a: "Dopamina",
      b: "Profesterona",
      c: "Paratormônio",
  ...
  },
  {
    ...
    correct: "c",
    scene: "/Assets/Scenes/soraAguinha.gif",
  },
  {
    question:
    ...
    correct: "b",
    scene: "/Assets/Scenes/soraProva.gif",
  },
  {
    question:
      "A hora da prova chegou! Sora está com medo por não saber a matéria. Seu corpo começa a produzir Cortisol e Adrenalina sem parar. O que está produzindo esses hormônios?",
    answer: {
      a: "Glândula Pineal",
      b: "Tireoide",
      c: "Grândulas Suprarenais",
      d: "Pâncreas",
    },
    correct: "c",
    scene: "/Assets/Scenes/soraProva.gif",
